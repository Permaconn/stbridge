...
ext = Extension(
    ...
    library_dirs=['/local/boost_1_80_0/lib64-msvc-14.3'],
    #libraries=['boost_python310-vc143-mt-x64-1_80'],	# This is automatically determined by boost (assuming a pragma comment lib)

    extra_compile_args=['/std:c++20', '-DWIN32', '-Ilibs/src/bridge', '-Ilibs/src/common', '-Ilibs/src/error', '-I../libraries/libusb-1.0.26/', '-I/local/boost_1_80_0'],
)
